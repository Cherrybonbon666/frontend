    ...
    <div class="background">
        ...
        <div class="container">
            <div v-for="product in products" :key="product.id">
                <img :src="product.men_pic" alt="Product Image">
                <h4 class="title">{{ product.men_name }}</h4>
                <h4 class="price">{{ product.men_price }}</h4>
...
.container div {
  width: calc(33.33% - 20px); /* Set the width to one-third of the container width minus some margin */
